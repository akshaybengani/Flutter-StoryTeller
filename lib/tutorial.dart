...
// ! This below code I have intentionally disabled 
...
//this is the default aspect ratio for a movie poster
...
//this is an arbitrary value I thought looked good. nothing special about it
  ...
  Widget build(BuildContext context) {
    return AspectRatio(
        ...
        child: LayoutBuilder(builder: (context, constraints) {
          ...
          //above aspect ratio ensures fixed width and height
          var height = constraints.maxHeight;

          var safeWidth = width - 2 * padding; 
          //in a "real" implementation, this would be passed in via the constructor
          ...
          //this value is the empty space to the left of the "primary" poster
          var hiddenPosterHorizontalInset = primaryPosterLeft / 2; 
          //two posters in the stack should be visible to the left of the "primary", divide that space evenly
